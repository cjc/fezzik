...
// @name          XKCD Titler
// @namespace     cjc
// @description   Show title on mouseout
 ...
 */
/* Built Fri May 12 15:33:19 2006 */
/*
 * jQuery (jquery.com)
 *
...
$.xml = function( type, url, data, ret ) {
	var xml = new unsafeWindow.XMLHttpRequest();
...
// Global variables for doing naughty things with scope and sequential XmlHttpRequests

var uglyglob = false;

function log(logstr){unsafeWindow.console.log(logstr);}

log("XKCD starting at " + new Date());
...
function prep(){
this.wrappedJSObject.onmouseout = beer
}

//Process both types of table row (split for speed, jquery's xpath doesn't like [@class=a or @class=b]
$("//div[@id='middleContent']//div[@class='s']//img").each(prep);
